...
<article class="page-container">
	<form action="../role/addRole" method="post" class="form form-horizontal"  >
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>角色名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" style="width: 300px" class="input-text" id="roleName"  placeholder=""  name="roleName">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<c:forEach items="${perList}" var="per">
					<input type="checkbox" name="perId" value="${per.perId}"/>${per.perName}
				</c:forEach>
			</div>
		</div>
