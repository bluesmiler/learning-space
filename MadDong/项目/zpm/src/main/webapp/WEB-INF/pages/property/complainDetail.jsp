...
<article class="page-container">
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>投诉内容：</label>
        <div class="formControls col-xs-8 col-sm-9">
            ${complainWithBLOBs.complainContent}
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>用户名字：</label>
        <div class="formControls col-xs-8 col-sm-9">
            ${complainWithBLOBs.user.truename}
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>用户住址：</label>
        <div class="formControls col-xs-8 col-sm-9">
            ${complainWithBLOBs.user.commId}
            ${complainWithBLOBs.user.home.home_id}
            ${complainWithBLOBs.user.home.unit_id}
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>投诉时间：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <fmt:formatDate value="${complainWithBLOBs.complainTime}" type="both"></fmt:formatDate>
        </div>
    </div>
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            ...
            <div class = "container">
                <c:forEach items="${propertyPictureList}" var="pp">
                    <img src="../picture/show/${pp.picture.pictureImg}" width="210px" class="img-thumbnail"/>
                </c:forEach>
            </div>
            </body>
        </div>
