...
<article class="page-container">
    ...
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>报修用户：</label>
        <div class="formControls col-xs-8 col-sm-9">
            ${repairs.user.truename}
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>报修时间：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <fmt:formatDate value="${repairs.repCreatetime}" type="both"></fmt:formatDate>
        </div>
    </div>
    <div class="row cl">
