...
<%--<form id="form"  action="repairs/insertSelective" enctype="multipart/form-data" method="post">--%>
		<%--详情：<textarea name="repContent"></textarea><br/>--%>
    ...
    <%--</div>--%>
	            ...
	            <%----%>
            <%--</div><br/>--%>
    <%--期望上门时间：<input type="date" name="repTime"/><br/>--%>
    	<%--<input id="bt" type="submit" name="submit" value="提交" /> --%>
<%--</form>--%>
<form class="form-horizontal" role="form" action="repairs/insertSelective" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group">
        <label  class="col-sm-2 control-label">期待上门时间:</label>
        <div class="col-sm-10">
