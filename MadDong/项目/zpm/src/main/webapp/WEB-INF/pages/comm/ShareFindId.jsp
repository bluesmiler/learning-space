...
<article class="blogs">
    <h1 class="t_nav"><span>您当前的位置：<a href="/index.html">首页</a>&nbsp;&gt;&nbsp;<a href="/news/s/">分享区</a>&nbsp;&gt;&nbsp;<a href="/news/s/">乐趣分享</a></span><a href="/" class="n1">网站首页</a><a href="/" class="n2">分享社区</a></h1>
    <div class="index_about">
        <h2 class="c_titile">${share.shareHeadline}</h2>
        <p class="box_c"><span class="d_time">发布时间：${share.shareTime}</span><span>编辑：${share.user.nickname}</span></p>
        <ul class="infos">

            <p>${share.shareContent}</p>
            <c:forEach items="${share.sharePictures}" var="pic">
                <p><img src="share/doshow?sharePictureName=${pic.sharePictureAttribute}" ></p>
            </c:forEach>
        </ul>
