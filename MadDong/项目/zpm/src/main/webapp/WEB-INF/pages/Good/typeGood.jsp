...
<header class="am-g am-g-fixed blog-fixed blog-text-center blog-header">
    <div class="am-u-sm-8 am-u-sm-centered">
        <h2 class="am-hide-sm-only">商品分类</h2>
    </div>
</header>
<hr>
<nav class="am-g am-g-fixed blog-fixed blog-nav">
    ...
    <div class="am-collapse am-topbar-collapse" id="blog-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav">
            ...
            <li class="am-active"><a>${type.name}</a></li>
        ...
        <c:forEach items="${list }" var="li">
            <article class="am-g blog-entry-article">
                ...
                <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                    ...
                    <a href="?id"><button class="am-btn-link"><span class="am-icon-eraser "></span>修改</button></a>
                    <p>${li.contentShort }</p>
                </div>
            </article>
        </c:forEach>
...
<div class="am-g am-g-fixed blog-fixed" >
    一共${page.pages}页
    <%--<p>${page.pageNum }</p>--%>
    <a href="good/typeGood?page=${page.firstPage}">第一页</a>
    <a href="good/typeGood?page=${page.prePage}">上一页</a>
    <c:forEach var='i' begin="1" end="${page.pages }" step="1">
        <a href="good/typeGood?page=${i }">${i }</a>
    </c:forEach>
    <a href="good/typeGood?page=${page.nextPage}">下一页</a>
    <a href="good/typeGood?page=${page.lastPage}">最后页</a>
</div>
