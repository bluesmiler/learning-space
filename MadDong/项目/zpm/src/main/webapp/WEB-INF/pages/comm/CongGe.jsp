...
<article class="blogs">
    <h1 class="t_nav"><span>有事说事儿，无事儿退堂。</span><a href="/" class="n1">网站首页</a><a href="/" class="n2">个人议事厅</a></h1>
    <div class="newblog left">
        <div id="content">
            <c:forEach items="${list}" var="list" >
                <div class="line"></div>
                <h2>${list.congressHallHeadline}</h2>
                <p class="dateview"><span>发布时间：${list.congressHallTime}</span><span>作者： ${list.user.nickname}</span><span>删除：[<a href="cong/delete/${list.congressHallId}">确定</a>]</span></p>
